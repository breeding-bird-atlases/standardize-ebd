...
ebd <- read_ebd("ebd_US-WI-091_201501_201912_relOct-2021.txt", unique = FALSE)
...
atlasers <- read.csv("WI eBirders 20210817.csv")
...
write.csv(ebdplussensitivepluszerocount, file= "EBDmergedwithSensitiveSpeciesandZeroCountRecords.csv", row.names=FALSE)
